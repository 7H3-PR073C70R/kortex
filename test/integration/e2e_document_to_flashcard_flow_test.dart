...
void main() {
  group('E2E Document to Vector Chunk & Flashcard Scheduler Flow Test Suite',
      () {
    ...
    const tOcrResults = [
      OcrExtractionEntity(
        ...
        rawText: 'Gibbs Free Energy is given by delta G = delta H - T delta S',
    ...
    setUp(() {
      ...
      generateDeckUseCase = GenerateFlashcardsFromDocUseCase(mockIngestionRepo);
    ...
    test(
      ...
      expect(reviewResult.algorithm, equals(SpacedRepetitionAlgorithm.fsrs));
