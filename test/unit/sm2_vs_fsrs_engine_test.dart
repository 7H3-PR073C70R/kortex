...
void main() {
  group('SM-2 vs FSRS-4.5 Algorithm Comparative Test Suite', () {
    ...
    test('Initial review comparison: SM-2 default vs FSRS-4.5 rating matrix',
        () {
      // SM-2 Good (Quality 4)
    ...
    test('Lapse handling: SM-2 resets repetitions, FSRS increments lapse count',
        () {
    ...
    test('SchedulerFactory outputs unified result matching active algorithm',
        () {
