...
class Caption extends AppTypography {
  Caption({
    TextStyle? regular,
    TextStyle? medium,
    TextStyle? semiBold,
  ...
  static const TextStyle _base = TextStyle(fontSize: 12);
  ...
  @override
  Caption lerp(covariant AppTypography other, double t) {
    if (other is! Caption) return this;
