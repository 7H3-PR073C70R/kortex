...
abstract class Either<L, R> extends Equatable {
  ...
  ///
  /// An [Either] object holds either a value of type [L] (Left) or [R] (Right).
  /// It provides utility methods like [fold], [isLeft], and [isRight]
  /// to work with the held value.
  const Either();

  /// Executes one of the provided functions based on whether the Either
  /// is Left or Right.
  ///
  /// If the Either is Left, [ifLeft] is executed with the Left value.
  /// If the Either is Right, [ifRight] is executed with the Right value.
