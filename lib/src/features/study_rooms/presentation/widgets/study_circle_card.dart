  ...
  Widget build(BuildContext context) {
    ...
    void openDetails() {
      if (onTapDetails != null) {
        ...
        unawaited(StudyCircleDetailSheet.show(context, circle));
      }
    }
            ...
            child: Column(
              ...
              children: [
                ...
                Container(
                  ...
                  decoration: BoxDecoration(
                    color: progress >= 1.0
                        ? colors.success.withAlpha(isDark ? 35 : 18)
                  ...
                  child: Row(
                    children: [
                      ...
                      Expanded(
                        child: Text(
                          progress >= 1.0
                              ? '🏆 Pod Quest Completed! (+250 XP All Members)'
                              : circle.podQuest,
                          style: typography.caption.bold.copyWith(
                            color: progress >= 1.0 ? colors.success : colors.primary,
                            fontSize: 10.5,
                ...
                if (circle.memberCount == 1) ...[
                  ...
                  Container(
                    ...
                    decoration: BoxDecoration(
                      color: colors.syllabotAccent.withAlpha(isDark ? 30 : 15),
                      borderRadius: AppRadius.radiusBadge,
                      border: Border.all(color: colors.syllabotAccent.withAlpha(40)),
                    ),
                    child: Row(
                      mainAxisSize: MainAxisSize.min,
                      children: [
                  ...
                  children: [
                    ...
                    Row(
                      children: [
                        for (
                          var i = 0;
                          i < circle.members.take(4).length;
                          i++
                        )
                          Align(
                            widthFactor: 0.7,
