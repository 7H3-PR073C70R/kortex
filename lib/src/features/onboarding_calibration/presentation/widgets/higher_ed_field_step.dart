...
class HigherEdFieldStep extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final selectedField = state.profile.higherEdField;
    final backendTracks = state.facultyTracks;

    final fields = backendTracks.isNotEmpty
        ? backendTracks.map((e) {
            return (
              e.displayName,
              e.subtitle,
              resolveCurriculumIcon(e.iconName),
            );
          }).toList()
        : [
            (
