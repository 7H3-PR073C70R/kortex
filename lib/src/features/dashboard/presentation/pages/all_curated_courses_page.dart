    ...
    return BlocProvider<DashboardBloc>.value(
      ...
      child: BlocBuilder<DashboardBloc, DashboardState>(
        builder: (context, dashState) {
          ...
          final allCourses =
              feed?.curatedCourses ?? const <CuratedCourseEntity>[];
                              ...
                              child: Row(
                                ...
                                children: [
                                  ...
                                  _buildStatItem(
                                    label: 'Available',
                                    value:
                                        '${allCourses.where((c) => c.hasActivePastPapers).length} Q-Banks',
...
class _CourseDetailedCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final realCoverage = hasDecks
        ? (decks.fold<double>(0, (s, d) => s + d.masteryRate) / decks.length)
              .clamp(0.0, 1.0)
        : 0.0;
                  ...
                  Row(
                    children: [
                      ...
                      _buildMetaPill(
                        ...
                        label:
                            '${decks.where((d) => d.dueCards > 0).length} Due',
                        colors: colors,
                        typography: typography,
                        isDark: isDark,
                      ),
