-- ==============================================================================
-- KORTEX SUPABASE MIGRATION: Fix get_dashboard_feed notifications read column
-- Resolves Postgres error 42703: column is_read does not exist -> use notifications.read
-- ==============================================================================
...
BEGIN
    ...
    -- 5. Unread Notifications Count (using correct 'read' column name)
